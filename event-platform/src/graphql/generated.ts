...
export type GetlLessonsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetlLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, lessonType: LessonType, availableAt?: any | null, title: string, slug: string }> };
...
export const GetlLessonsDocument = gql`
    query GetlLessons {
...
/**
 * __useGetlLessonsQuery__
 *
 * To run a query within a React component, call `useGetlLessonsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetlLessonsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetlLessonsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetlLessonsQuery(baseOptions?: Apollo.QueryHookOptions<GetlLessonsQuery, GetlLessonsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetlLessonsQuery, GetlLessonsQueryVariables>(GetlLessonsDocument, options);
      }
export function useGetlLessonsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetlLessonsQuery, GetlLessonsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetlLessonsQuery, GetlLessonsQueryVariables>(GetlLessonsDocument, options);
        }
export type GetlLessonsQueryHookResult = ReturnType<typeof useGetlLessonsQuery>;
export type GetlLessonsLazyQueryHookResult = ReturnType<typeof useGetlLessonsLazyQuery>;
export type GetlLessonsQueryResult = Apollo.QueryResult<GetlLessonsQuery, GetlLessonsQueryVariables>;